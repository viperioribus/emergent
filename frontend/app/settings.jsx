...
export default function SettingsScreen() {
  ...
  const [selectedBeachPost, setSelectedBeachPost] = useState(null);
  ...
  const loadBeachPosts = async (beachId) => {
  ...
  const handleBeachSelect = async (beach) => {
  ...
  const handleBeachPostSelect = async (post) => {
